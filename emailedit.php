...
function check_mail_to_parents(){
    return confirm ("Επιλέξατε να αποσταλεί Ειδοποιητήριο Απουσιών με e-mail\nσε κηδεμόνες μαθητών που έχουν καταχωρημένο e-mail.\nθέλετε να συνεχίσετε;")
}
    // -->
</script>
