...
$sumtotapG = 0;
$sumtotapG += isset ( $sumarray [3] ["sumtotap"] ) ? $sumarray [3] ["sumtotap"] : 0;
$sumtotapG += isset ( $sumarray [4] ["sumtotap"] ) ? $sumarray [4] ["sumtotap"] : 0;
$sumtotapG += isset ( $sumarray [5] ["sumtotap"] ) ? $sumarray [5] ["sumtotap"] : 0;

$sumdayspG = 0;
$sumdayspG += isset ( $sumarray [3] ["sumdaysp"] ) ? $sumarray [3] ["sumdaysp"] : 0;
$sumdayspG += isset ( $sumarray [4] ["sumdaysp"] ) ? $sumarray [4] ["sumdaysp"] : 0;
$sumtotapG += isset ( $sumarray [5] ["sumdaysp"] ) ? $sumarray [5] ["sumdaysp"] : 0;

$sumdG_array = array ();
for($x = 0; $x < $dik_count; $x ++) {
	$kod = 'sumd' . $dikaiologisi_define [$x] ['kod'];
	$sumdG_array [$x] = 0;
	$sumdG_array [$x] += isset ( $sumarray [3] [$kod] ) ? $sumarray [3] [$kod] : 0;
	$sumdG_array [$x] += isset ( $sumarray [4] [$kod] ) ? $sumarray [4] [$kod] : 0;
	$sumdG_array [$x] += isset ( $sumarray [5] [$kod] ) ? $sumarray [5] [$kod] : 0;
}

$sumoaG = 0;
$sumoaG += isset ( $sumarray [3] ["sumoa"] ) ? $sumarray [3] ["sumoa"] : 0;
$sumoaG += isset ( $sumarray [4] ["sumoa"] ) ? $sumarray [4] ["sumoa"] : 0;
$sumoaG += isset ( $sumarray [5] ["sumoa"] ) ? $sumarray [5] ["sumoa"] : 0;

$sumdaG = 0;
$sumdaG += isset ( $sumarray [3] ["sumda"] ) ? $sumarray [3] ["sumda"] : 0;
$sumdaG += isset ( $sumarray [4] ["sumda"] ) ? $sumarray [4] ["sumda"] : 0;
$sumdaG += isset ( $sumarray [5] ["sumda"] ) ? $sumarray [5] ["sumda"] : 0;

$sumfhG = 0;
$sumfhG += isset ( $sumarray [3] ["sumfh"] ) ? $sumarray [3] ["sumfh"] : 0;
$sumfhG += isset ( $sumarray [4] ["sumfh"] ) ? $sumarray [4] ["sumfh"] : 0;
$sumfhG += isset ( $sumarray [5] ["sumfh"] ) ? $sumarray [5] ["sumfh"] : 0;

$summhG = 0;
$summhG += isset ( $sumarray [3] ["summh"] ) ? $sumarray [3] ["summh"] : 0;
$summhG += isset ( $sumarray [4] ["summh"] ) ? $sumarray [4] ["summh"] : 0;
$summhG += isset ( $sumarray [5] ["summh"] ) ? $sumarray [5] ["summh"] : 0;

$sumlhG = 0;
$sumlhG += isset ( $sumarray [3] ["sumlh"] ) ? $sumarray [3] ["sumlh"] : 0;
$sumlhG += isset ( $sumarray [4] ["sumlh"] ) ? $sumarray [4] ["sumlh"] : 0;
$sumlhG += isset ( $sumarray [5] ["sumlh"] ) ? $sumarray [5] ["sumlh"] : 0;

$sumdikG = 0;
for($x = 0; $x < $dik_count; $x ++) {
	$sumdikG += $sumdG_array [$x];
}
$sumadikG = $sumtotapG - $sumdikG;
$sumoadaG = $sumoaG + $sumdaG;
...
$mytextdata .= "</td>
	<td rowspan=\"3\" class=\"bigfont\"  id=\"white\"> ";
if ($sumtotapA == 0)
	$mytextdata .= "&nbsp;";
else
...
if ($sumadikA == 0)
	...
	$mytextdata .= $sumadikA;
$mytextdata .= "</td>
	<td rowspan=\"3\" class=\"bigfont\"  id=\"green\"> ";
if ($sumdayspA == 0)
	$mytextdata .= "&nbsp;";
else
...
for($x = 0; $x < $dik_count; $x ++) {
	$mytextdata .= "</td>
	<td rowspan=\"3\" class=\"bigfont\"  id=\"$color_array[$x]\"> ";
	if ($sumdA_array [$x] == 0) {
		$mytextdata .= "&nbsp;";
	} else {
...
$mytextdata .= "</td>
	<td rowspan=\"3\" class=\"bigfont\"  id=\"grey\"> ";
if ($sumoaA == 0)
	$mytextdata .= "&nbsp;";
else
	$mytextdata .= $sumoaA;
...
$mytextdata .= "</td>
	...
	<td class=\"demifont\" id=\"white\" > ";
if (isset ( $sumarray ['1'] ['sumtotap'] ) && $sumarray ['1'] ['sumtotap'] > 0) {
