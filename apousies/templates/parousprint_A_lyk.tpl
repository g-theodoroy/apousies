            ...
            <div class="block">
                <div class="column span-24 last" align="center">
                    ...
                    {foreach from=$studentspinakas item='studentdata' name='for'}
                        ...
                        {else}
                            {if isset($studentdata.detaildata[$month][$i][0])}
                                <td align='center' class='{$studentdata.detaildata[$month][$i][2]}' ><b>{$studentdata.detaildata[$month][$i][0]}</b></td>       
                            {else}
                                <td align='center' class='{$background}'>&nbsp;</td>
                            {/if}
                        {/if}
                        {/for}
                    </tr>
