...
// Vincent Blavet - vincentphpconcept.net
...
==============
  ...
  Version 2.0 :
    ***** Warning : Some new features may break the backward compatibility for your scripts.
    ...
    - Add better support for windows paths (thanks for help from manusmanusfreedom.com).
...
===========
  ...
  I will also appreciate that you send me a mail (vincentphpconcept.net), just to
...
==========
  ...
  This software was written by Vincent Blavet (vincentphpconcept.net) on its leasure time.

9 - Contribute
==============
  If you want to contribute to the development of PclZip, please contact vincentphpconcept.net.
