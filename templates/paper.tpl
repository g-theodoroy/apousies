    ...
    <body>
        ...
        {foreach from=$mypd item=foo} 
            ...
            <div style="margin : 0 auto 0 auto; width :{$totalwidth}mm; height:{$totalheight}mm; ">
                ...
                <div style="width :50%; height:10mm;float: left ; ">ΣΧΟΛΙΚΗ ΜΟΝΑΔΑ: {if isset($foo.txtdata.sch_name)}{$foo.txtdata.sch_name}{/if}</div>
                <div style="width :50%; height:10mm;float: right ; text-align: right;">ΣΧΟΛΙΚΟ ΕΤΟΣ: {if isset($foo.txtdata.sch_year)}{$foo.txtdata.sch_year}{/if}</div>

                <div style="width :100%; height:10mm;clear:both;text-align:center;"><h2>ΔΕΛΤΙΟ ΕΠΙΚΟΙΝΩΝΙΑΣ  ΣΧΟΛΕΙΟΥ - ΓΟΝΕΩΝ</h2></div>
                ...
                <div style="width :15%; height:25mm;float: left ;text-align: right;text-indent:0mm;" >
                    ΕΠΩΝΥΜΟ:<br>
                    ΟΝΟΜΑ:<br>
                    ΤΑΞΗ:<br>
                    ΤΜΗΜΑ:
                </div>
                <div style="width :35%;height:25mm; float: left ;text-indent:0mm;" >
                ...
                <div style="width :45%;height:25mm; float: right ;padding-left:5%;">
                ...
                <div style="width :100%; height:20mm;clear:both;">
                ...
                <div style="width :100%;height:6mm;">Αναλυτικά:</div>
                <div style="width :100%;height:85mm;">
                ...
                <div style="width :100%;height:15mm; clear:both;">
                    &nbsp;
                </div>
